---
title: XorShift128
documentation_of: //math/xorshift-128/src/lib.rs
---

128-bit state xorshift pseudo-random number generator (Marsaglia). Internal state is four $u32$ words, initialized from a single seed via splitmix64.
...
Returns the next raw $u32$ value.
...
Returns the next $u64$ value, composed of two consecutive `next_u32` results.
