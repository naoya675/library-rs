...
data:
  ...
  code: "#[derive(Debug, Clone, Copy)]\npub struct Edge {\n    from: usize,\n    to:\
    ...
    \ dfs1 = Recursive {\n            f: &|dfs: &Recursive<'_>, env: &mut Env, v:\
    \ usize| {\n                env.visited[v] = true;\n                for i in fg.start[v]..fg.start[v\
    \ + 1] {\n                    let to = fg.elist[i].to;\n                    if\
    \ !env.visited[to] {\n                        (dfs.f)(dfs, env, to);\n       \
    \             }\n                }\n                env.ord.push(v);\n       \
    \     },\n        };\n\n        let dfs2 = Recursive {\n            f: &|dfs:\
    \ &Recursive<'_>, env: &mut Env, v: usize| {\n                env.ids[v] = env.group_num;\n\
    \                env.visited[v] = true;\n                for i in rg.start[v]..rg.start[v\
  ...
  requiredBy: []
  timestamp: '2025-09-12 03:48:35+09:00'
