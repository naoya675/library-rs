...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.yosupo.jp/problem/vertex_set_path_composite\n\
    ...
    \ v, 0);\n        et.add_edge(v, u, 0);\n    });\n    et.init(0);\n\n    let val\
    \ = |x: u64, y: u64| (Mint::new(x), Mint::new(y));\n    let invval = |x: u64,\
    \ y: u64| (Mint::new(1) / Mint::new(x), -Mint::new(y) / Mint::new(x));\n    let\
    \ mut st1 = SegmentTree::<(Mint, Mint)>::new(n + n, |x, y| (x.0 * y.0, x.1 * y.0\
    \ + y.1), val(1, 0));\n    let mut st2 = SegmentTree::<(Mint, Mint)>::new(n +\
    \ n, |y, x| (x.0 * y.0, x.1 * y.0 + y.1), val(1, 0));\n    for i in 0..n {\n \
