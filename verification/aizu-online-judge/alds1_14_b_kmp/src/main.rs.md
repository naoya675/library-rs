...
data:
  ...
  code: "// verification-helper: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_14_B\n\
    ...
    \ i in kmp(&t, &p) {\n        println!(\"{}\", i);\n    }\n}\n"
  dependsOn:
  - string/knuth-morris-pratt/src/lib.rs
  ...
  verifiedWith: []
documentation_of: verification/aizu-online-judge/alds1_14_b_kmp/src/main.rs
layout: document
redirect_from:
- /verify/verification/aizu-online-judge/alds1_14_b_kmp/src/main.rs
- /verify/verification/aizu-online-judge/alds1_14_b_kmp/src/main.rs.html
